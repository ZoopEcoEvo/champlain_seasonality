...
Across group comparisons show that there are generally no differences in thermal limits, with the exception of Senecella males, which may have lower thermal limits (although sample sizes are very small in this group).
