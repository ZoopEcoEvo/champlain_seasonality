...
```{r main-fig-ctmax-timeseries, fig.width=10, fig.height=5}
...
```{r supp-fig-sp-props, fig.width = 12, fig.height = 5}
adult_summaries %>% 
  ungroup() %>% 
...
```{r supp-fig-deveggs-props, fig.height = 12, fig.width = 8}
...
```{r supp-fig-lipids-props, fig.height = 12, fig.width = 8}
...
```{r main-fig-sp-summaries, fig.width=14, fig.height=5}
...
```{r misc-ARR-limits-plot, fig.width=8, fig.height=6}
...
```{r main-fig-ARR-synth-plot, fig.width=8, fig.height=6}
...
```{r supp-fig-arr-comp-plot, fig.width=8, fig.height=10, include = F}
...
mle_coefs = coefficients(full.model)$`sp_name` %>% 
  ...
  select(group, "intercept" = "(Intercept)", "ARR" = temp_cent) %>% 
  remove_rownames()
...
```{r supp-fig-ctmax-sex, fig.width=7, fig.height=7}
ctmax_resids %>% 
...
```{r supp-fig-ctmax-stage, fig.width=7, fig.height=7}
ctmax_resids %>% 
...
Previous studies have shown that the magnitude of the size-fecundity correlation may be environmentally-dependent. 
