...
Supp Figure: 
1. Measured temperature vs. max temp from the env. logger
2. Pathogen prevalence
3. Days in lab 
4. Sex/Stage differences 
5. Average CTmax vs. Average size for species/sex/stage groups
6. Size-fecundity correlation coefficients vs. temperature
7. L. sicilis size ridge plots
